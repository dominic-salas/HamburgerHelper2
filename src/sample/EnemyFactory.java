...
public class EnemyFactory {
    ...
    public EnemyFactory(Group root) {
        spawnInit(root);
    ...
    public void spawnNew(Group root) {
        enemies.add(new BasicEnemy(root, rand.nextInt(700), rand.nextInt(700)));
    }

    private void spawnInit(Group root) {
        for (int i = 0; i < 4; i++) {
            spawnNew(root);
        }
    }
